$PBExportHeader$w_tstws_frame.srw
$PBExportComments$Generated MDI Frame
forward
global type w_tstws_frame from window
end type
type mdi_1 from mdiclient within w_tstws_frame
end type
end forward
...
global w_tstws_frame w_tstws_frame

type variables
n_tstws_sheetmanager inv_sheetmgt
end variables

forward prototypes
public function long of_getsheetcount ()
public function integer of_sheetisclosing (readonly w_tstws_basesheet aw_sheet)
public function long of_classcount (readonly w_tstws_basesheet aw_sheet)
public function integer of_adjustmenu (ref m_tstws_frame am_menu)
end prototypes
...
string ls_sheets[]  = { "w_tstws_sheet1", "w_tstws_sheet2", "w_tstws_sheet3" }
...
inv_sheetmgt = Create n_tstws_sheetmanager

this.Post Event ue_postopen ( )
end event

on w_tstws_frame.create
if this.MenuName = "m_tstws_frame" then this.MenuID = create m_tstws_frame
this.mdi_1=create mdi_1
this.Control[]={this.mdi_1}
end on

on w_tstws_frame.destroy
