$PBExportHeader$n_tstws_sheetmanager.sru
$PBExportComments$Generated MDI Sheet Management
forward
global type n_tstws_sheetmanager from nonvisualobject
end type
end forward

global type n_tstws_sheetmanager from nonvisualobject
end type
global n_tstws_sheetmanager n_tstws_sheetmanager

type variables
string is_sheets[], is_display[]
w_tstws_basesheet iw_opensheets[]
menu im_items[]
end variables
...
public function long of_sheetisclosing (readonly w_tstws_basesheet aw_sheet)
...
li_rc = OpenSheet ( lw_sheet, as_sheetname, w_tstws_frame, 0, Cascaded! ) 
...
w_tstws_basesheet lw_sheets[], lw_init[]
...
w_tstws_sheet1	lw_sheet1
w_tstws_sheet2	lw_sheet2
w_tstws_sheet3	lw_sheet3
...
on n_tstws_sheetmanager.create
call super::create
TriggerEvent( this, "constructor" )
end on

on n_tstws_sheetmanager.destroy
